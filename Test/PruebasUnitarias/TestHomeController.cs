...
namespace FinalCalidad.Test.PruebasUnitarias
{
    [TestFixture]
    public class TestHomeController
    {
        ...
        [Test]
        public void AddGastoErrorIsOkTest()
        {
            ...
            var home = new HomeController(IBancoServicesMock.Object, IValidacionServiceMock.Object);
            home.ModelState.AddModelError("Error", "No Carga");
            var result = home.AddGasto(new Gasto()) as ViewResult;


            Assert.IsInstanceOf<ViewResult>(result);
        }
        [Test]
        public void AddGastoIsOkTest()
        {
            ...
            var result = home.AddGasto(new Gasto());


            Assert.IsInstanceOf<RedirectToRouteResult>(result);
        }
        [Test]
        public void VerSaldoIsOk()
        {
